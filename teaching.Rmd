...
[Christopher Clifford](https://www.linkedin.com/in/christophermclifford/) (co-mentored with Drs. Leslie Frazier and Timothy Hayes) is a senior statistician at the University of New Mexico. His dissertation examined different approaches to using latent variables in regression models (e.g., structural equation models versus estimated factor scores) with the aim of making the relative strengths and weaknesses of these methods understandable to developmental scientists. 

[April Schantz](https://www.linkedin.com/in/aschantz/) (co-mentored with Dr. Valentina Bruk-Lee) is a research psychologist at the U.S. Army Research Institute. Her dissertation examined the impact of person-environment fit on strain and well-being among first responders using response surface regression. [Dissertation](https://digitalcommons.fiu.edu/etd/3768/)

[Tyler Stout](https://www.linkedin.com/in/tylerstout1/) is a manager of machine learning at GEICO. His dissertation examined how variability in cluster size impacts parameter estimates and statistical power in mixed models, with an application to stress in the workplace. [Dissertation](https://digitalcommons.fiu.edu/etd/2979/)

## Courses

### **Introduction to Biostatistics (BTS 510)**
...
- Course website: [Summer 2024](https://stefanycoxe.github.io/BTS510_Summer24/)
